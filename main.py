...
class TaskScreen(MDBoxLayout):
    ...
    def save_user_input(self, instance, value, date_range):
...
_, unmarked_tasks = Database_notes.get_tasks()

cM, cT, cW, cTh, cF, cSa, cSu = 0, 0, 0, 0, 0, 0, 0

for task in unmarked_tasks:
...
class MainApp(MDApp):
    ...
    def on_start(self):
        marked_tasks, unmarked_tasks = Database_notes.get_tasks()
